...
If your location placed in the midle of nowhere, you will get a random fact about Chuck Norrisas as a consolation prize.
...
Make sure you are registred on the Weather Data Services:

https://www.visualcrossing.com/weather/weather-data-services#/login

Then copy your personal API key and paste in the empty file "TOKEN.txt".

*****************

After that, create new bot in Telegram. Type \start to BotFather and follow the instructions. Copy token of your new bot and paste in the empty file "BOT_TOKEN.txt"

*****************

Open cmd and type "cd C:\...\per_aspera_ad_astra"
...
Type "python script.py" in cmd and send "start" to your bot.
